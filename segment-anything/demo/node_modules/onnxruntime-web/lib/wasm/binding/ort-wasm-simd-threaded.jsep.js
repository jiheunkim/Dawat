...
var T,Ga={891692:()=>{B.jsepRunPromise=new Promise(function(a){B.tb=a})},891787:a=>{B.tb(a)},891825:a=>B.ob(a),891858:a=>B.qb(a),891890:(a,b,c)=>{B.ab(a,b,c,!0)},891929:(a,b,c)=>{B.ab(a,b,c)},891962:a=>{B.xa("Abs",a,void 0)},892013:a=>{B.xa("Neg",a,void 0)},892064:a=>{B.xa("Floor",a,void 0)},892117:a=>{B.xa("Ceil",a,void 0)},892169:a=>{B.xa("Reciprocal",a,void 0)},892227:a=>{B.xa("Sqrt",a,void 0)},892279:a=>{B.xa("Exp",a,void 0)},892330:a=>{B.xa("Erf",a,void 0)},892381:a=>{B.xa("Sigmoid",a,void 0)},
892436:a=>{B.xa("Log",a,void 0)},892487:a=>{B.xa("Sin",a,void 0)},892538:a=>{B.xa("Cos",a,void 0)},892589:a=>{B.xa("Tan",a,void 0)},892640:a=>{B.xa("Asin",a,void 0)},892692:a=>{B.xa("Acos",a,void 0)},892744:a=>{B.xa("Atan",a,void 0)},892796:a=>{B.xa("Sinh",a,void 0)},892848:a=>{B.xa("Cosh",a,void 0)},892900:a=>{B.xa("Asinh",a,void 0)},892953:a=>{B.xa("Acosh",a,void 0)},893006:a=>{B.xa("Atanh",a,void 0)},893059:a=>{B.xa("Tanh",a,void 0)},893111:(a,b,c)=>{B.xa("ClipV10",a,{min:b,max:c})},893183:a=>
{B.xa("Clip",a,void 0)},893235:(a,b)=>{B.xa("Elu",a,{alpha:b})},893293:a=>{B.xa("Relu",a,void 0)},893345:(a,b)=>{B.xa("LeakyRelu",a,{alpha:b})},893409:(a,b)=>{B.xa("ThresholdedRelu",a,{alpha:b})},893479:(a,b)=>{B.xa("Cast",a,{to:b})},893537:a=>{B.xa("Add",a,void 0)},893588:a=>{B.xa("Sub",a,void 0)},893639:a=>{B.xa("Mul",a,void 0)},893690:a=>{B.xa("Div",a,void 0)},893741:a=>{B.xa("Pow",a,void 0)},893792:(a,b,c,e,f)=>{B.xa("ReduceMean",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>
0,f+e>>>0)):[]})},893956:(a,b,c,e,f)=>{B.xa("ReduceMax",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>0,f+e>>>0)):[]})},894119:(a,b,c,e,f)=>{B.xa("ReduceMin",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>0,f+e>>>0)):[]})},894282:(a,b,c,e,f)=>{B.xa("ReduceProd",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>0,f+e>>>0)):[]})},894446:(a,b,c,e,f)=>{B.xa("ReduceSum",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>
0,f+e>>>0)):[]})},894609:(a,b,c,e,f)=>{B.xa("ReduceL1",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>0,f+e>>>0)):[]})},894771:(a,b,c,e,f)=>{B.xa("ReduceL2",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>0,f+e>>>0)):[]})},894933:(a,b,c,e,f)=>{B.xa("ReduceLogSum",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>0,f+e>>>0)):[]})},895099:(a,b,c,e,f)=>{B.xa("ReduceSumSquare",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>
0,f+e>>>0)):[]})},895268:(a,b,c,e,f)=>{B.xa("ReduceLogSumExp",a,{keepDims:!!b,noopWithEmptyAxes:!!c,axes:e?Array.from(z().subarray(f>>>0,f+e>>>0)):[]})},895437:(a,b,c)=>{B.xa("Transpose",a,{perm:b?Array.from(z().subarray(c>>>0,c+b>>>0)):[]})},895550:(a,b,c,e,f,h,k,m,v,n)=>{B.xa("Conv",a,{format:v?"NHWC":"NCHW",auto_pad:b,dilations:[c],group:e,kernel_shape:[f],pads:[h,k],strides:[m],w_is_const:()=>!!d()[n>>>0]})},895778:(a,b,c,e,f,h,k,m,v,n,r,x,y,g,t)=>{B.xa("Conv",a,{format:g?"NHWC":"NCHW",auto_pad:b,
dilations:[c,e],group:f,kernel_shape:[h,k],pads:[m,v,n,r],strides:[x,y],w_is_const:()=>!!d()[t>>>0]})},896037:(a,b,c,e,f,h,k,m,v,n)=>{B.xa("Conv",a,{format:v?"NHWC":"NCHW",auto_pad:b,dilations:[c],group:e,kernel_shape:[f],pads:[h,k],strides:[m],w_is_const:()=>!!d()[n>>>0]})},896265:(a,b,c,e,f,h,k,m,v,n,r,x,y,g,t)=>{B.xa("Conv",a,{format:g?"NHWC":"NCHW",auto_pad:b,dilations:[c,e],group:f,kernel_shape:[h,k],pads:[m,v,n,r],strides:[x,y],w_is_const:()=>!!d()[t>>>0]})},896524:(a,b,c,e,f,h,k,m,v,n,r,x,
y,g)=>{B.xa("ConvTranspose",a,{format:v?"NHWC":"NCHW",autoPad:b,dilations:[c],group:e,kernel_shape:[f],pads:[h,k],strides:[m],wIsConst:()=>!!d()[n>>>0],outputPadding:r?Array.from(z().subarray(x>>>0,x+r>>>0)):[],outputShape:y?Array.from(z().subarray(g>>>0,g+y>>>0)):[]})},896904:(a,b,c,e,f,h,k,m,v,n,r,x,y)=>{B.xa("ConvTranspose",a,{format:m?"NHWC":"NCHW",autoPad:b,dilations:Array.from(z().subarray(c>>>0,c+2>>>0)),group:e,kernelShape:Array.from(z().subarray(f>>>0,f+2>>>0)),pads:Array.from(z().subarray(h>>>
...
0)):[]})},897807:(a,b,c,e,f,h,k,m,v,n,r,x,y)=>{B.xa("ConvTranspose",a,{format:m?"NHWC":"NCHW",autoPad:b,dilations:Array.from(z().subarray(c>>>0,c+2>>>0)),group:e,kernelShape:Array.from(z().subarray(f>>>0,f+2>>>0)),pads:Array.from(z().subarray(h>>>0,h+4>>>0)),strides:Array.from(z().subarray(k>>>0,k+2>>>0)),wIsConst:()=>!!d()[v>>>0],outputPadding:0<n?Array.from(z().subarray(r>>>0,r+n>>>0)):[],outputShape:0<x?Array.from(z().subarray(y>>>0,y+x>>>0)):[]})},898330:(a,b)=>{B.xa("GlobalAveragePool",a,{format:b?
"NHWC":"NCHW"})},898421:(a,b,c,e,f,h,k,m,v,n,r,x,y,g,t,w)=>{B.xa("AveragePool",a,{format:w?"NHWC":"NCHW",auto_pad:b,ceil_mode:c,count_include_pad:e,storage_order:f,dilations:[h,k],kernel_shape:[m,v],pads:[n,r,x,y],strides:[g,t]})},898705:(a,b)=>{B.xa("GlobalAveragePool",a,{format:b?"NHWC":"NCHW"})},898796:(a,b,c,e,f,h,k,m,v,n,r,x,y,g,t,w)=>{B.xa("AveragePool",a,{format:w?"NHWC":"NCHW",auto_pad:b,ceil_mode:c,count_include_pad:e,storage_order:f,dilations:[h,k],kernel_shape:[m,v],pads:[n,r,x,y],strides:[g,
t]})},899080:(a,b)=>{B.xa("GlobalMaxPool",a,{format:b?"NHWC":"NCHW"})},899167:(a,b,c,e,f,h,k,m,v,n,r,x,y,g,t,w)=>{B.xa("MaxPool",a,{format:w?"NHWC":"NCHW",auto_pad:b,ceil_mode:c,count_include_pad:e,storage_order:f,dilations:[h,k],kernel_shape:[m,v],pads:[n,r,x,y],strides:[g,t]})},899447:(a,b)=>{B.xa("GlobalMaxPool",a,{format:b?"NHWC":"NCHW"})},899534:(a,b,c,e,f,h,k,m,v,n,r,x,y,g,t,w)=>{B.xa("MaxPool",a,{format:w?"NHWC":"NCHW",auto_pad:b,ceil_mode:c,count_include_pad:e,storage_order:f,dilations:[h,
k],kernel_shape:[m,v],pads:[n,r,x,y],strides:[g,t]})},899814:(a,b,c,e,f)=>{B.xa("Gemm",a,{alpha:b,beta:c,transA:e,transB:f})},899918:a=>{B.xa("MatMul",a,void 0)},899972:(a,b,c,e)=>{B.xa("ArgMax",a,{keepDims:!!b,selectLastIndex:!!c,axis:e})},900080:(a,b,c,e)=>{B.xa("ArgMin",a,{keepDims:!!b,selectLastIndex:!!c,axis:e})},900188:(a,b)=>{B.xa("Softmax",a,{axis:b})},900251:(a,b)=>{B.xa("Concat",a,{axis:b})},900311:(a,b,c,e,f)=>{B.xa("Split",a,{axis:b,numOutputs:c,splitSizes:e?Array.from(z().subarray(f>>>
0,f+e>>>0)):[]})},900456:a=>{B.xa("Expand",a,void 0)},900510:(a,b)=>{B.xa("Gather",a,{axis:Number(b)})},900581:(a,b,c,e,f,h,k,m,v,n,r)=>{B.xa("Resize",a,{antialias:b,axes:c?Array.from(z().subarray(e>>>0,e+c>>>0)):[],coordinateTransformMode:U(f),cubicCoeffA:h,excludeOutside:k,extrapolationValue:m,keepAspectRatioPolicy:U(v),mode:U(n),nearestMode:U(r)})},900932:(a,b,c,e,f,h,k)=>{B.xa("Slice",a,{starts:b?Array.from(z().subarray(c>>>0,c+b>>>0)):[],ends:e?Array.from(z().subarray(f>>>0,f+e>>>0)):[],axes:h?
Array.from(z().subarray(k>>>0,k+h>>>0)):[]})},901163:a=>{B.xa("Tile",a,void 0)},901215:(a,b,c)=>{B.xa("LayerNormalization",a,{axis:Number(b),epsilon:Number(c)})},901322:(a,b,c)=>{B.xa("InstanceNormalization",a,{epsilon:b,format:c?"NHWC":"NCHW"})},901436:(a,b,c)=>{B.xa("InstanceNormalization",a,{epsilon:b,format:c?"NHWC":"NCHW"})},901550:a=>{B.xa("Gelu",a,void 0)},901602:(a,b)=>{B.xa("SkipLayerNormalization",a,{epsilon:b})},901683:a=>{B.rb(a)},901717:(a,b)=>B.sb(a,b)};
...
var Gb=(a,b,c,e)=>(Gb=M.Aa)(a,b,c,e),Qa=a=>(Qa=M.Ba)(a),Xa=B.__emscripten_thread_exit=a=>(Xa=B.__emscripten_thread_exit=M.Ca)(a),ub=B.__emscripten_check_mailbox=()=>(ub=B.__emscripten_check_mailbox=M.Da)(),tc=a=>(tc=M.Ea)(a),Ua=(a,b)=>(Ua=M.Fa)(a,b),Db=()=>(Db=M.Ga)(),Va=a=>(Va=M.Ha)(a),Fb=a=>(Fb=M.Ia)(a),Wa=B.dynCall_ii=(a,b)=>(Wa=B.dynCall_ii=M.Ka)(a,b),nc=a=>(nc=M.La)(a),cc=()=>(cc=M.Ma)(),mc=a=>(mc=M.Na)(a),oc=()=>(oc=M.Oa)();B.___start_em_js=901752;B.___stop_em_js=901913;
