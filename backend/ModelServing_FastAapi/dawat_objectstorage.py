...
class ObjectStorageSample:
    def __init__(self):
        ...
        self.access_key = 'DhVtze56hwJMyn5Poizh'
        self.secret_key = 'u2J5HFgTHKoNcWUDT4X0QZ4DXQjltI8gjZkGmOp1'
    ...
    def put_object(self, bucket_name, folder_name, object_name, source_file_path, request_parameters=None):
        http_method = 'PUT'
        ...
        with open(source_file_path, 'rb') as f:
            ...
            request_path = '/%s/%s/%s' % (bucket_name, folder_name, object_name)
    ...
    def list_objects(self, bucket_name, request_parameters=None):
        ...
        'content': r.json() if r.status_code == 200 else None
        }

        return response_data
    
    def grant_bucket_acl(self, bucket_name, folder_name, acl):
        http_method = 'PUT'
        ...
        request_path = f'/{bucket_name}/{folder_name}?acl='

        self._sign(http_method, request_path, headers, time)

        request_url = f'https://{self.host}/{bucket_name}/{folder_name}?acl='
